...
using WaterS.Application.Specifications.ExtendedAttribute;
using WaterS.Domain.Contracts;
using WaterS.Domain.Enums;
using WaterS.Shared.Wrapper;

namespace WaterS.Application.Features.ExtendedAttributes.Queries.Export
{
