...
namespace WaterS.Client.Infrastructure.Managers.Identity.Users
{
    public class UserManager : IUserManager
    {
        ...
        public async Task<IResult<List<UserResponse>>> GetAllAsync()
        {
          ...
          public async Task<IResult<UserResponse>> GetAllAsyncByUser(string UserName)
        {
            var response = await _httpClient.GetAsync(Routes.UserEndpoints.GetByName(UserName));
