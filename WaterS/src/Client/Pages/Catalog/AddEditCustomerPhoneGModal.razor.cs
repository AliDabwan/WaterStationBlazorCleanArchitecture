...
{
    public partial class AddEditCustomerPhoneGModal
    {
        ...
        private async Task SaveAsync()
        {
            ...
            //_snackBar.Add("comp :"+ AddEditCustomerPhoneModel.CompanyId);
            //_snackBar.Add("customer :" + AddEditCustomerPhoneModel.CustomerId);
