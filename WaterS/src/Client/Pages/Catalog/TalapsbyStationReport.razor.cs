...
{
    public partial class TalapsbyStationReport
    {
        ...
        private void DoReport()
        {
            ...
            if (BYdate)
            {
                _navigationManager.NavigateTo($"/talapbystationReport/{_dateRange?.Start.Value.ToString("yyyy-MM-dd")}/" +
                    $"{_dateRange?.End.Value.ToString("yyyy-MM-dd")}/{talapStatue}/{searchValue}/{mystion}");

            }
            else
            {
                _navigationManager.NavigateTo($"/talapbystationReport/{talapStatue}/{searchValue}/{mystion}");
