...
{
    public partial class ViewCustomerModal
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (user.Identity?.IsAuthenticated == true)
            {
                ...
                if (customer.Succeeded)
                {
                    ...
                    _phones = customer.Data.Where(x=>x.CustomerId== AddEditCustomerModel.Id).ToList();
                }
        ...
        private async Task InvokeModalSowCustomer(int id = 0)
        {
            ...
            if (id != 0)
            {
                ...
                if (customer != null)
                {
                    parameters.Add(nameof(ViewPhoneCustomerModal.AddEditCustomerModel), new AddEditCustomerPhoneCommand
                    {
                        CustomerId = id,
            ...
            var dialog = _dialogService.Show<ViewPhoneCustomerModal>(id == 0 ? _localizer["Create"] : _localizer["Edit"], parameters, options);
