...
{
    public partial class WaitingTalaps
    {
        ...
        public string talapdate { get; set; } = "all";
        public int talapRegion { get; set; } = 0;
        ...
        private async Task LoadData(int pageNumber, int pageSize, TableState state)
        {
            ...
            {
                regId = selectedRegionValue;

            }
            var request = new GetAllPagedTalapsRequest { PageSize = pageSize, PageNumber = pageNumber + 1, CompanyId = mycomp, StationId = mystion,RegionId= regId, DriverId = mydriver
                , CustomerId = mycustomer,DateFrom= dateeFrom,DateTo= dateeTo,
                Statue = "Running", SearchString = _searchString, Orderby = orderings };
            ...
            if (response.Succeeded)
            {
                ...
                //    _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && (x.CreatedOn.Date >= DateTime.Now.Date && x.CreatedOn.Date <= DateTime.Now.Date));
                ...
                //    _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && (x.CreatedOn.Date >= DateTime.Now.Date.AddDays(-7) && x.CreatedOn.Date <= DateTime.Now.Date));
                ...
                //    _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && (x.CreatedOn.Date >= DateTime.Now.Date.AddMonths(-1) && x.CreatedOn.Date <= DateTime.Now.Date));
                ...
                //    _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && (x.CreatedOn.Date >= _dateRange.Start.Value.Date && x.CreatedOn.Date <= _dateRange.End.Value.Date));
                ...
                //       _pagedData = mm.Where(x => x.TalapStatue == "Running").ToList();
        ...
        //    var request = new GetAllPagedTalapsRequest { PageSize = pageSize, PageNumber = pageNumber + 1, SearchString = _searchString, Orderby = orderings };
        //    var response = await TalapManager.GetTalapsAsync(request);
        ...
        //        if (CurrentUserRool == RoleConstants.AdministratorRole || CurrentUserRool == RoleConstants.AdminRole)
        //        {
        //            _pagedData = response.Data.Where(x=> x.TalapStatue == "Running").ToList();
        //            _totalItems = _pagedData.Count();
        ...
        //            _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && x.CompanyId == mycomp).ToList();
        //            _totalItems = _pagedData.Count();
        ...
        //            _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && x.CompanyId == mycomp && x.StationId == mystion).ToList();
        //            _totalItems = _pagedData.Count();
        ...
        //            _pagedData = response.Data.Where(x => x.TalapStatue== "Running" && x.CompanyId == mycomp && x.StationId == mystion && x.DriverId == mydriver).ToList();
        //            _totalItems = _pagedData.Count();

        //        }
        //        else
        //        {
        //            _pagedData = response.Data.Where(x => x.TalapStatue == "Running" && x.CompanyId == mycomp && x.StationId == mystion && x.DriverId == mydriver && x.CustomerId == mycustomer).ToList();
        //            _totalItems = _pagedData.Count();
        ...
        private void Onclose()
        {
               ...
               var ssFrom = _dateRange?.Start.HasValue;
            var ssTo = _dateRange?.End.HasValue;
