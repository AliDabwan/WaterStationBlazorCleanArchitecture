...
using WaterS.Client.Infrastructure.Mappings;
    ...
    public partial class RolePermissions
    {
        ...
        private async Task GetRolePermissionsAsync()
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    if (claim.Group == "Documents" || claim.Group == "DocumentTypes" ||
                        claim.Group == "DocumentExtendedAttributes" || claim.Group == "RoleClaims")
                    {
