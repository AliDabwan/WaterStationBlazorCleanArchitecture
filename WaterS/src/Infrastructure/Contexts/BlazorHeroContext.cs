...
namespace WaterS.Infrastructure.Contexts
{
    public class BlazorHeroContext : AuditableContext
    {
        ...
        public DbSet<Talap> Talaps  { get; set; }
        public DbSet<CustomerPhone> CustomerPhones { get; set; }

        public DbSet<Customer> Customers  { get; set; }
        public DbSet<DriverRegion> DriverRegions  { get; set; }
        public DbSet<Accounts> Accounts  { get; set; }
        public DbSet<AccTrans> AccTrans  { get; set; }
        public DbSet<AccTransMovment> AccTransMovment { get; set; }
            ...
            foreach (var entry in ChangeTracker.Entries<IAuditableEntity>().ToList())
            {
                switch (entry.State)
                {
                    case EntityState.Added:
                        entry.Entity.CreatedOn = _dateTimeService.NowLocal;
                        entry.Entity.CreatedBy = _currentUserService.UserId;
                        break;

                    case EntityState.Modified:
                        entry.Entity.LastModifiedOn = _dateTimeService.NowLocal;
