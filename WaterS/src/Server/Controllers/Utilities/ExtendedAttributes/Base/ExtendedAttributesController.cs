...
using WaterS.Application.Features.ExtendedAttributes.Commands.Delete;
...
using WaterS.Application.Features.ExtendedAttributes.Queries.GetById;
using WaterS.Domain.Contracts;

namespace WaterS.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
