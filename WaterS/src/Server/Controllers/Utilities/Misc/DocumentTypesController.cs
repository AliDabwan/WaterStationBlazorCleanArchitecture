...
using WaterS.Application.Features.DocumentTypes.Commands.Delete;
using WaterS.Application.Features.DocumentTypes.Queries.Export;
...
namespace WaterS.Server.Controllers.Utilities.Misc
{
